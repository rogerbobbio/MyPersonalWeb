    ...
    public partial class completeDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PositionRolId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(maxLength: 50, nullable: false),
                    PositionId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositionRols", x => x.PositionRolId);
                    table.ForeignKey(
                        name: "FK_PositionRols_Positions_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Champions = table.Column<bool>(nullable: false),
                    PlayerTypeId = table.Column<int>(nullable: false),
                    LeagueId = table.Column<int>(nullable: false),
                    TeamId = table.Column<int>(nullable: false),
                    PositionId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Players_PositionRols_PositionRolId",
                        column: x => x.PositionRolId,
                        principalTable: "PositionRols",
                        principalColumn: "PositionRolId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Players_PositionRolId",
                table: "Players",
                column: "PositionRolId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PositionRols_PositionId",
                table: "PositionRols",
                column: "PositionId");
